...
//     description: "Engineered a high-performance career engine implementing JWT-based authentication matrices, secure Cloudinary media management streams, and centralized state handling via Redux Toolkit.",
//     tech: ["MongoDB", "Express", "React", "Node.js", "JWT", "Redux Toolkit", "Cloudinary", "Tailwind CSS", "Framer Motion"],
//     image: "/projects/radiantix.jpg",
//     liveLink: "https://radiantix.render.com",
//     githubLink: "https://github.com/justkmr/RadiAntiX",
//     featured: true,
//     category: "fullstack",
...
//     description: "Built a next-gen grocery delivery framework operating on Next.js 15 layout structures, utilizing Socket.io engine for microsecond location tracking events, and secure Stripe payment hooks.",
//     tech: ["Next.js 15", "Socket.io", "Stripe API", "Tailwind CSS", "Node.js"],
//     image: "/projects/zestco.jpg",
//     liveLink: "https://zestco.dev",
...
//     id: "p3",
//     title: "VECTOR LABS",
//     subtitle: "AI CORE PROMPT HUB",
//     description: "An open-source technical environment tailored to parse, map, and filter generative vectors using structural async database routing.",
