...
const terminalCardReveal: Variants = {
  ...
  visible: {
    ...
    transition: {
      duration: 0.9,
      ease: [0.25, 1, 0.5, 1] as const, // 🟢 Forced strict tuple compilation layer
    },
  },
};
        ...
        >
          {PROJECT_EXPERIENCE_DATA.map((job: JobProjectLog) => (
            <motion.div
              ...
              className="w-full bg-[#050506]/95 border border-zinc-900 rounded-[16px] p-6 md:p-8 flex flex-col shadow-2xl transition-all duration-300 relative group/card overflow-hidden"
            >
              <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#E24C60]/40 to-transparent translate-y-[-100%] group-hover/card:animate-[scan_2s_linear_infinite] pointer-events-none" />
