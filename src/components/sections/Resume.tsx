...
// // =========================================================================
// // 📑 DATA ENGINE MATRIX FOR RESUME SECTION
// // =========================================================================
...
// // Advanced Clip Path Scanner Transition Matrix
...
//     >
//       {/* Background Grid Pattern Array Overlay */}
...
//         {/* Title Dynamic Glitch Tracker Block */}
//         <motion.div
...
//                 boxShadow: "0 25px 60px -20px rgba(234,179,8,0.03)",
//               }}
...
//             >
//               {/* Laser Core Overlay Lines Scanner Effect */}
//               <div className="absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-[#eab308]/40 to-transparent translate-y-[-100%] group-hover/card:animate-[scan_2s_linear_infinite] pointer-events-none" />

//               {/* <div className="w-full flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-zinc-900/60 pb-5 mb-5 relative z-10">
//                 <div className="flex flex-col">
//                   <h4 className="text-[19px] md:text-2xl font-black text-white tracking-wide">
//                     {job.role}{" "}
//                     <span className="text-zinc-600 font-medium text-base md:text-lg">
//                       ({job.projectName})
//                     </span>
//                   </h4>
//                   <div className="flex items-center gap-2 mt-1">
//                     <span className="text-[15px] px-2.5 py-2 rounded-[12px] bg-zinc-900 border border-zinc-800 text-[#E24C60] font-black uppercase tracking-wider">
//                       {job.type}
//                     </span>
//                   </div>
//                 </div>

//                 <div className="flex flex-col md:text-right shrink-0 font-bold">
//                   <span className="text-[15px] text-[#E24C60] capitalize bg-zinc-900/40 border border-zinc-900/80 px-3 py-1 rounded-full">
//                     {job.duration}
//                   </span>
//                   <span className="text-[13px] text-zinc-500 tracking-wide mt-2 block">
//                     {job.location}
//                   </span>
//                 </div>
//               </div> */}

//               {/* 🟢 FULLY FIX BOUNDS: Ye poora structure copy-paste karo jo right side data ko strictly control karega */}
...
//                     <span className="text-[12px] md:text-[15px] px-2.5 py-1.5 md:py-2 rounded-[12px] bg-zinc-900 border border-zinc-800 text-[#E24C60] font-black uppercase tracking-wider whitespace-nowrap">
//                       {job.type}
//                     </span>
//                   </div>
//                 </div>

//                 {/* Right Date Segment Block */}
//                 {/* 🟢 FIXED CRITICAL OVERFLOW: flex-row hta ke grid layout rules lagaye hain jo sm screens par limits cross nhi karne denge */}
//                 <div className="flex flex-col items-start md:items-end justify-start shrink-0 font-mono w-full md:w-auto min-w-0">
...
//                         <h5 className="text-[18px] font-black text-white  tracking-tight group-hover/award:text-[#E24C60] transition-colors">
//                           {award.title}
//                         </h5>
...
//                         </span>
//                       </div>
//                       <span className="text-[16px] font-bold text-zinc-500  tracking-wider mt-0.5">
//                         {award.category}
//                       </span>
...
//                       <div className="text-[12px] font-black text-[#E24C60] tracking-widest uppercase mt-3 bg-[#E24C60]/5 px-2.5 py-1 rounded-[12px] border border-amber-500/10 inline-block self-start shadow-inner">
...
//         >
//           <motion.div
//             className="w-16 h-16 bg-linear-to-r from-red-500 to-red-600 rounded-[12px] flex items-center justify-center mx-auto mb-6"
//             initial={{ scale: 0, rotate: -180 }}
//             whileInView={{ scale: 1, rotate: 0 }}
//             transition={{ duration: 0.8, delay: 0.2 }}
//             viewport={{ once: true }}
//           >
//             <FaDownload className="text-neutral-400 text-3xl" />
//           </motion.div>
...
//             experience, projects, and technical skills. Let&apos;s build
        ...
        >
          {PROJECT_EXPERIENCE_DATA.map((job: JobProjectLog) => (
            ...
            >
              ...
              {/* 🟢 FIXED NON-OVERFLOW LAYOUT: Exact original styles and colors */}
              <div className="w-full flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-zinc-900/60 pb-5 mb-5 relative z-10 overflow-hidden">
