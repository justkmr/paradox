              ...
              >
                {TRACK_TWO.map((tech, idx) => (
                  <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 350, damping: 20 }}
                    style={{ backgroundColor: tech.color }}
                    className="flex items-center gap-4 border border-white/[0.05] backdrop-blur-md px-6 py-3 rounded-[15px] hover:bg-[#0f1013]/90 hover:shadow-[0_15px_30px_rgba(226,76,96,0.06)] transition-all duration-300 cursor-default group"
                  >
                    <img
                      src={tech.icon}
                      alt={tech.name}
