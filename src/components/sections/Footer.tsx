...
// const Footer = () => {
//   return (
//     <div className="w-full flex flex-col items-center border-t border-zinc-900   relative overflow-hidden select-none">
//       <div className="absolute bottom-[20px] md:bottom-[-60px] left-1/2 -translate-x-1/2 pointer-events-none z-0 tracking-tighter font-sans font-black select-none text-center whitespace-nowrap w-full flex justify-center items-end opacity-40">
//         <span
//           className="text-[90px] sm:text-[160px] md:text-[240px] lg:text-[320px] leading-none "
//           style={{
//             color: "transparent",
//             WebkitTextStroke: "1.5px #E24C60",
//             textShadow: "0 0 40px rgba(226, 76, 96, 0.15)",
//           }}
//         >
//           K
//         </span>

//         <span className="text-[90px] sm:text-[160px] md:text-[240px] lg:text-[320px] text-zinc-900/40 leading-none">
//           umarrR.
//         </span>
//       </div>

//       <div className="absolute bottom-[-20px] md:bottom-[-60px] left-1/2 -translate-x-1/2 pointer-events-auto z-0 tracking-tighter font-sans font-black select-none text-center whitespace-nowrap w-full flex justify-center items-end opacity-40 group/watermark transition-all duration-500 cursor-default ">
//         <span
//           className="text-[90px] sm:text-[160px] md:text-[240px] lg:text-[320px] leading-none transition-all duration-500 ease-out group-hover/watermark:filter-[drop-shadow(0_0_45px_rgba(226,76,96,0.95))_drop-shadow(0_0_80px_rgba(226,76,96,0.4))]"
//           style={{
//             color: "transparent",
//             WebkitTextStroke: "1.5px rgba(226, 76, 96, 0.5)",
//             filter: "drop-shadow(0 0 20px rgba(226, 76, 96, 0.15))",
//           }}
//         >
//           K
//         </span>

//         {/* Remaining Character Sequence Layer: Seamlessly morphs from dark-zinc to glowing brand red */}
//         <span className="text-[90px] sm:text-[160px] md:text-[240px] lg:text-[320px] text-zinc-900/40 leading-none transition-all duration-500 ease-out group-hover/watermark:text-[#E24C60] group-hover/watermark:[filter:drop-shadow(0_0_40px_rgba(226,76,96,0.75))]">
//           umarrR.
//         </span>
//       </div>

//       <div className="relative z-10 mt-10 w-full flex flex-col items-center pb-15 ">
...
//         {/* Rights Matrix Copy Block */}
//         <div className="w-full text-center text-[16px] text-zinc-500 font-medium tracking-wide font-mono flex flex-col gap-1.5 border-t border-zinc-950/40 max-w-6xl mx-auto px-4">
...
const Footer = () => {
  ...
  return (
    ...
    <div className="w-full flex flex-col items-center border-t border-zinc-900 pt-16 pb-24 xs:pb-28 sm:pb-32 md:pb-16 relative select-none">
      {/* =========================================================================
          🔮 GLOBAL CUSTOM CSS ENGINE (Pixel-Perfect Letters Symmetry)
          ========================================================================= */}
      <style jsx global>{`
      ...
      {/* =========================================================================
          🔮 DESKTOP LAYER: INDIVIDUAL LETTER HOVER GLOW (Hidden on Mobile)
          ========================================================================= */}
