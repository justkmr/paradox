...
const Footer = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center border-t border-zinc-900 pt-16 pb-24 xs:pb-28 sm:pb-32 md:pb-16 relative select-none">
      ...
      <div className="md:hidden absolute bottom-22.5 xs:bottom-[105px] sm:bottom-30 left-1/2 -translate-x-1/2 pointer-events-none z-0 font-sans font-black select-none text-center w-full opacity-40 tracking-tight leading-none whitespace-nowrap flex justify-center items-end px-4 mobile-watermark">
