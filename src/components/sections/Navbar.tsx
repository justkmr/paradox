    ...
    <div className="fixed top-0 left-0 w-full z-50 flex justify-center p-4 md:p-6 pointer-events-none isolation-isolate">
      <header className="w-full max-w-7xl pointer-events-auto flex items-center justify-between bg-[#0b0c0e]/60 backdrop-blur-2xl border border-white/5 rounded-[24px] p-2 shadow-[0_24px_60px_-15px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.05)] relative overflow-hidden">
        ...
        <div className="flex items-center gap-4.5 pr-5 pl-3 border-r border-red-600/40 py-1.5 h-full">
          ...
          <div className="flex flex-col font-mono text-left hidden sm:flex select-none">
        ...
        <div className="flex items-center gap-4 pl-4 border-l border-red-600/40 py-1">
          ...
          <motion.a
            href="#contact"
            className="bg-linear-to-b from-[#E24C60] to-[#c73b4e] text-white font-mono text-xs font-bold uppercase tracking-wider px-6 py-3 rounded-full flex items-center gap-2.5 shadow-[0_8px_25px_rgba(226,76,96,0.25),inset_0_1px_0_rgba(255,255,255,0.2)] pointer-events-auto border border-[#E24C60]/30"
            whileHover={{
              scale: 1.03,
