...
// 🌟 FIXED: Pure HTML SVG Objects for absolute runtime stability
const highlights = [
  {
    icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        <path d="M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.41zM15.41 16.59L20 12l-4.59-4.41L16.82 6l6 6-6 6-1.41-1.41zM4.59 16.59L0 12l4.59-4.41L3.18 6l6 6-6 6-1.41-1.41z" />
      </svg>
    ),
    title: "Full-Stack Developer",
    description:
      "Specialized in React Components Pages & full Stack Development Ecosystem",
  },
  {
    icon: (
      <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
