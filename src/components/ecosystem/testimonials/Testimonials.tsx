        ...
        <div className="flex items-center justify-between w-full mb-6 relative z-10">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="p-2 rounded-xl bg-white/1 hover:bg-[#E24C60]/5 border border-white/5 hover:border-[#E24C60]/30 text-zinc-400 hover:text-[#E24C60] transition-all duration-300 cursor-pointer"
            >
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
