...
export function Testimonials() {
  // 🚀 INTERACTIVE DYNAMIC HOVER EXTENDED CARD
  const TestimonialCard = ({ node }: { node: TestimonialNode }) => (
    <div className="w-[390px] sm:w-[450px] shrink-0 p-8 sm:p-10 rounded-[38px] border border-white/[0.04] bg-white/[0.01] backdrop-blur-2xl transition-all duration-500 flex flex-col justify-between group relative overflow-hidden select-none cursor-pointer hover:bg-[#090a0f] hover:border-[#E24C60]/40 hover:shadow-[0_40px_90px_-15px_rgba(226,76,96,0.15),0_60px_120px_-20px_rgba(0,0,0,0.9)] hover:-translate-y-2">
      {/* 🔮 ULTRA-THIN RAINBOW GRADIENT BORDER TRACE EFFECT */}
      <div
        className={`absolute inset-0 bg-gradient-to-r ${node.gradient} opacity-0 group-hover:opacity-40 transition-opacity duration-500 pointer-events-none p-[1.5px] rounded-[38px]`}
        style={{
          WebkitMask:
      ...
      {/* 🌌 Dynamic Intense Crimson Glow Backlight on Hover */}
      ...
      {/* Top Glass Reflection Edge Shimmer */}
        ...
        <div className="flex items-center justify-between w-full mb-6 relative z-10">
          <div className="flex items-center gap-4 text-left">
            ...
            <div className="relative w-14 h-14 rounded-2xl p-[1.5px] bg-white/[0.02] border border-white/10 group-hover:border-[#E24C60]/40 transition-colors duration-500 shadow-inner shrink-0 rotate-3 group-hover:rotate-0">
              <Image
                ...
                alt={node.name}
                fill
                className="w-full h-full rounded-2xl bg-zinc-950/40 object-cover"
                loading="eager"
              />
            </div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-white/[0.01] hover:bg-white/5 border border-white/5 hover:border-white/20 text-zinc-400 hover:text-white transition-all duration-300 cursor-pointer"
            >
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-white/[0.01] hover:bg-[#E24C60]/5 border border-white/5 hover:border-[#E24C60]/30 text-zinc-400 hover:text-[#E24C60] transition-all duration-300 cursor-pointer"
            >
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
      ...
      {/* Transparent Matrix Sub-Footer Block */}
