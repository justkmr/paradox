      ...
      <div className="grid sm:grid-cols-2 gap-6 w-full font-mono">
        {FEATURED_REPOS.map((repo, index) => (
          ...
          >
            ...
            <div className="absolute left-0 top-0 w-[4px] h-full bg-zinc-900 group-hover:bg-[#E24C60] group-hover:shadow-[0_0_15px_#E24C60] transition-all duration-500 pointer-events-none" />

            {/* Split Decorative Header Line */}
            <div className="absolute top-0 right-12 w-24 h-[3px] bg-gradient-to-r from-transparent via-white/10 to-transparent pointer-events-none" />
            ...
            <div className="relative z-10 w-full">
              ...
              <div className="w-full p-4 rounded-[25px] transparent border border-white/[0.02] mb-6 relative overflow-hidden group-hover:border-white/5 transition-colors">
            ...
            <div className="flex flex-wrap gap-2 relative z-10 w-full pt-2 border-t border-white/[0.03]">
              {repo.tags.map((tag) => (
                <span
                  key={tag}
