...
export function GithubCard({ data }: { data: ProfileData }) {
  return (
    <motion.div
      ...
      className="w-full p-8 rounded-[32px] border border-white/5 bg-linear-to-b from-white/3 to-transparent backdrop-blur-2xl relative group shadow-[0_50px_100px_rgba(0,0,0,0.9)] overflow-hidden font-mono flex flex-col justify-between min-h-145"
    >
      ...
      <div>
        <div className="flex items-center justify-between w-full mb-8">
          ...
          <span className="text-[10px] text-gray-300 bg-[#E24C60] p-1 w-fit h-fit  rounded-full  tracking-widest uppercase shadow-[0_0_8px_#E24C60] ">
            Terminal v1.0
          </span>
        </div>
      ...
      <div>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mt-6 w-full py-4 px-4 rounded-[18px] bg-white/5 hover:bg-white/10 border border-white/5 hover:border-[#E24C60]/30 text-center text-[10px] sm:text-xs font-black tracking-[0.15em] sm:tracking-[0.25em] text-white transition-all flex items-center justify-center gap-2 sm:gap-3 group-hover:shadow-[0_15px_30px_rgba(0,0,0,0.4)]"
        >
